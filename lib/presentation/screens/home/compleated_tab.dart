...
class CompletedTab extends ConsumerStatefulWidget {
  ...
  const CompletedTab({super.key, required this.tasks});

  @override
  CompletedTabState createState() => CompletedTabState();
}

class CompletedTabState extends ConsumerState<CompletedTab> {
